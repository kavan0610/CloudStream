...
export const AudioProvider = ({ children, driveToken, userId, onTokenRefresh }) => {
  ...
  const { 
    ...
    currentTrack, isShufflingRef, playContext, toggleShuffle, 
  ...
  return (
    <AudioContext.Provider value={{
      ...
      playContext, togglePlay, handleNext, handlePrev, seek, changeVolume, toggleShuffle, toggleRepeat, preloadContext, syncActiveContext
    }}>
      {children}
